...
<p>
<label for="email">Email <input class="input" 
type="text" name="email" required></label>
</p>
<p>
<label for="password">Password <input class="input" 
type="password" name="password" required></label>
</p>
<p>
<label for="repassword">Re-Password <input class="input" 
type="password" name="repassword" required></label>
</p>
